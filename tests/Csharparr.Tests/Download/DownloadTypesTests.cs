...
public class DownloadTypesTests
{
    ...
    {
        var config = new AppConfig();
        var putioTransfer = new PutioTransfer(1);
        var transfer = new Transfer(config, putioTransfer);

        var targets = new List<DownloadTarget>
        {
            new("/path1", TargetType: TargetType.Directory, TopLevel: true),
            new("/path2", TargetType: TargetType.File, TopLevel: false)
        };
    ...
    public void Transfer_GetTopLevel_WithNoTopLevel_ShouldReturnNull()
    {
        ...
        var targets = new List<DownloadTarget>
        {
            new("/path1", TopLevel: false),
            new("/path2", TopLevel: false)
        };
    ...
    public void Transfer_GetFileTargets_ShouldReturnOnlyFiles()
    {
        ...
        var targets = new List<DownloadTarget>
        {
            new("/path1", TargetType: TargetType.Directory),
            new("/path2", TargetType: TargetType.File),
            new("/path3", TargetType: TargetType.File)
        };
    ...
    {
        var config = new AppConfig();
        var putioTransfer = new PutioTransfer(1, Name: "Test");
        var transfer = new Transfer(config, putioTransfer);
    ...
    public void Transfer_ThreadSafety_SetAndGetTargets()
    {
        ...
        var targets1 = new List<DownloadTarget> { new("/path1") };
        var targets2 = new List<DownloadTarget> { new("/path2") };
