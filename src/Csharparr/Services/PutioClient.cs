...
public sealed class ListTransferResponse
{
    public List<PutioTransfer> Transfers { get; set; } = [];
}

public sealed class GetTransferResponse
{
    public required PutioTransfer Transfer { get; set; }
}

public sealed class PutioTransfer
{
...
public sealed class ListFileResponse
{
    public List<FileInfo> Files { get; set; } = [];
    public required FileInfo Parent { get; set; }
}
